...
##### `v2.0.4`
- feat(CreateNotice): FormFeedback valid, toggleFade
- refactor(Profiles): toggleFade
...
##### `v2.0.0-beta.1`
- refactor(AddAcademicCalender): move to AppSwitch component
- fix: typo
...
- refactor(CreateNotice): `card-header-actions`
- feat(CreateNotice): `<Input type="date">`
- feat(CreateNotice): `FormFeedback`
...
- fix typo in AddClassSchedule component PaginationItem
