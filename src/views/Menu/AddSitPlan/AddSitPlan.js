...
class AddSitPlan extends Component {
        ...
        <Card>
          <CardHeader>
            ...
            <div className="card-header-actions">
              <a href="https://reactstrap.github.io/components/navs/AddSitPlan.js" rel="noreferrer noopener" target="_blank" className="card-header-action">
